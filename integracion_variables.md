...
El siguiente esquema muestra las tres versiones del modelo conceptual que hemos generado en clase. También se puede descargar aquí en formato visible por [diagrams](https://app.diagrams.net/). :
